-- Run this SQL in your Supabase SQL Editor to add the amount_paid field to sales table
...
-- Update the fetchSales query to include cost_price in sale_items->products
-- This is automatically handled by the updated React components 